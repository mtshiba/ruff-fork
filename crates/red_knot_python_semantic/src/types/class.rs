        ...
        for attribute_assignment in attribute_assignments(db, class_body_scope, name) {
            ...
            match binding.kind(db) {
                DefinitionKind::AnnotatedAssignment(ann_assign) => {
                    ...
                    let annotation_ty =
                        infer_expression_type(db, ann_assign.annotation_expression());
                ...
                DefinitionKind::Assignment(assign) => {
                    match assign.target_kind() {
                        ...
                        TargetKind::Name => {
                            ...
                            let inferred_ty = infer_expression_type(db, assign.value_expression());
                ...
                DefinitionKind::For(for_stmt) => {
                    match for_stmt.target_kind() {
                        ...
                        TargetKind::Name => {
                            ...
                            let iterable_ty =
                                infer_expression_type(db, for_stmt.iterable_expression());
                ...
                DefinitionKind::WithItem(with_item) => {
                    match with_item.target_kind() {
                        ...
                        TargetKind::Name => {
                            ...
                            let context_ty =
                                infer_expression_type(db, with_item.context_expr_expression());
